...
So this is Nurse Joy's job, not a judge's. A Pokémon walks into the **Pokémon Center** and she has
to decide, right there, from the Pokémon in front of her: **is this one fit to go back out?**
...
than in Blackthorn cannot be used to set a rule.
...
* **✨ She over-rewards a Pokémon that looks well.** A translation that reads smoothly beats a
  ...
  looks magnificent and may be exhausted underneath. Glossy is not healthy.
